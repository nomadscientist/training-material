...
> ### {% icon hands_on %} Hands-on
>
> **MultiQC** {% icon tool %} with the following parameters (please note that sometimes MultiQC doesn't appear from using the search box. You'll find it under FASTQ Quality Control categories):
>    - In *"Results"*:
>      - In *"1:Results"*:
