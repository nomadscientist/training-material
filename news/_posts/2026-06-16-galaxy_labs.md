---
title: "GalaxyLabs paper is live!
A love letter from the Galaxy Single-cell and sPatial Omics Community"
contributions:
...
1. Subdomain interfaces (Galaxy, Single-cell, etc.) were previously server-specific: so if the galaxy.eu server had a genomics subdomain and there was a genomics community of users on a different server, they’d have to spin up their own subdomain from scratch. This included both content and tooling. How annoying for a Single-cell and sPatial Omics Community that works across continents!
2. These different servers made **training** extremely difficult, where user’s experiences wildly varied when trying to follow tutorials and often led to confusion and frustration.
3. Subdomains had no template or consistent, user research informed experience - and became whatever a given individual or group might throw together. How annoying given how little time we all have, to have to collectively contribute and maintain so many sites!
...
You can read the [whole story on how this many year mission went down](https://galaxyproject.org/news/2026-05-14-galaxy-labs-engine-reflections/) and also enjoy the fruits of this labour, for accessing the myriad of Galaxy Labs across servers.
